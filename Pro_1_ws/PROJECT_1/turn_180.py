...
class Turn180Node(Node):
    def __init__(self):
        ...
        self.declare_parameter('target_deg', 180.0)     # Quay 180 độ
        ...
        self.get_logger().info("=== BẮT ĐẦU QUAY 180 ĐỘ ===")
    ...
    def control_loop(self):
        ...
        if rem_rad <= math.radians(0.5):
            ...
            self.get_logger().info(f"✅ ĐÃ HOÀN THÀNH QUAY 180°! (Góc đạt: {current_deg:.2f}°)")
            return
        ...
        self.get_logger().info(f"Đang quay 180: {current_deg:.1f}° / 180.0°", throttle_duration_sec=0.5)
