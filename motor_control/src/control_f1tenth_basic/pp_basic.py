...
class PurePursuit(Node):
    def __init__(self):
        ...
        self.L = 0.35    # Chiều dài cơ sở (Wheelbase)
        self.kq = 1.0    # Hệ số Gain góc lái
        
        # --- CẤU HÌNH ADAPTIVE LOOKAHEAD (MỚI) ---
        # Công thức: Ld = clamp(speed * time, min, max)
        self.lookahead_time = 0.8    # T_lookahead (giây): Xe nhìn trước bao nhiêu giây?
        ...
        self.MAX_SPEED = 1.7
        self.MIN_SPEED = 1.7 # Bạn đang để min = max, xe sẽ chạy đều
        self.MAX_ANGLE = 0.35
