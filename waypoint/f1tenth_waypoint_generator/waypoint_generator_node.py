...
site_packages_path = f'{get_package_prefix("waypoint")}/lib/python3.8/site-packages'
...
class WaypointGenerator(Node):
    def __init__(self, waypoint_type:WaypointType, clicked_waypoint:ClickedWaypoint)->None:
...
def main(args=None):
    ...
    clicked_waypoint = ClickedWaypoint(share_node); 
    
    waypoint_node = WaypointGenerator(WaypointType, clicked_waypoint)
